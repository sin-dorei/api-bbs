  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item @if(request()->url() === route('topics.index')) active @endif"><a class="nav-link"
            href="{{ route('topics.index') }}">话题</a></li>
        <li class="nav-item @if(request()->url() === route('categories.show', 1)) active @endif"><a class="nav-link"
            href="{{ route('categories.show', 1) }}">分享</a></li>
        <li class="nav-item @if(request()->url() === route('categories.show', 2)) active @endif"><a class="nav-link"
            href="{{ route('categories.show', 2) }}">教程</a></li>
        <li class="nav-item @if(request()->url() === route('categories.show', 3)) active @endif"><a class="nav-link"
            href="{{ route('categories.show', 3) }}">问答</a></li>
        <li class="nav-item @if(request()->url() === route('categories.show', 4)) active @endif"><a class="nav-link"
