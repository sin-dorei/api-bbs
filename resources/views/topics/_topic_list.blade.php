  ...
  <li class="media">
    ...
    <div class="media-body">
      ...
      <div class="media-heading mt-0 mb-1">
        ...
        <a class="float-right" href="{{ route('topics.show', $topic) }}">
      ...
      <small class="media-body meta text-secondary">
        ...
        <a class="text-secondary" href="{{ route('topics.index', ['category_id' => $topic->category_id]) }}" title="{{ $topic->category->name }}">
